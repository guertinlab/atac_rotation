...
only for the three candidates motif: CRE, NFYB and Ronin

```{r, engine='bash', eval=F, echo=T}
plot.df = data.frame()

fimo.scores.atac.subset<-fimo.scores.atac[, c(1,7,9)]
...
![traces](images/three_isolated_families_dynamic_accessibility.jpg)
### motif density plot by cluster
